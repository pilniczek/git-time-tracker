...
export interface NormalizedEvent {
  ...
  sourceBranch?: string;
  branch?: string;
  // True for entries pulled in from before the requested date window to seed
  // branch state for `annotateCommitBranches`. Filtered out before display.
  isSeed?: boolean;
}
